...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_PROBLEM_AND_SOLUTION_TABLE="CREATE TABLE "+PROBLEM_AND_SOLUTION_TABLE+"( "+PROBLEM_ID+" INTEGER PRIMARY KEY AUTOINCREMENT, "+TITLE+" VARCHAR(100), "+PROBLEM_STATEMENT+" VARCHAR(500), "+
            SOLUTION+" VARCHAR(50), "+TAG+" VARCHAR(100),"+SETTER+" VARCHAR(25),"+SYNC_STATUS+" INTEGER,"+UPDATE_DATE+" VARCHAR(25)); ";
    ...
    private static final String CREATE_USER_INFORMATION_TABLE="CREATE TABLE "+USER_INFORMATION_TABLE+"( "+NAME+" VARCHAR(25), "+USER_NAME+" VARCHAR(25), "+PASSWORD+" VARCHAR(25), "+GENDER+" VARCHAR(25), "+DATE_BIRTH+" VARCHAR(25), "+EMAIL+" VARCHAR(25), "+PHONE_NUMBER+" VARCHAR(25), "+INSTITUTION+" VARCHAR(50), "+SOLVING_STRING+" VARCHAR(10010), "+TOTAL_SOLVED+" VARCHAR(25), "+DbContract.SYNC_STATUS+" INTEGER,"+LOGIN_STATUS+" INTEGER);";
    ...
    public long insertData(String title,String problemStatement,String solution,String tag,String setter,int synStatus,String updateDate){
    ...
    public synchronized long insertData(String name,String userName,String password,String gender,String dateBirth,String email,String phone,String institution,String solvingString,String totalSolved,int syncstatus,int logStatus){
        ...
        contentValues.put(LOGIN_STATUS,logStatus);
    ...
    public Cursor query(String tableName,String USERNAME){
     ...
     SQLiteDatabase sqLiteDatabase=this.getReadableDatabase();
        ...
        if(tableName.equals(USER_INFORMATION_TABLE)){
            ...
            cursor=sqLiteDatabase.rawQuery("SELECT name,userName,password,gender,dateBirth,email,phone,institution,solvingString,totalSolved,loginStatus FROM userInformation WHERE userName= ?",selectionArgs);
        }
        return cursor;
    ...
    public void updateLocalDatabase(int loginStatus){//userInformation

        sqLiteDatabase=getWritableDatabase();

        ContentValues contentValues=new ContentValues();
        contentValues.put(LOGIN_STATUS,loginStatus);

        String selection =USER_NAME+" LIKE ?";
        String[] selection_args={DbContract.CURRENT_USER_NAME};
        sqLiteDatabase.update(USER_INFORMATION_TABLE,contentValues,selection,selection_args);
    ...
    public void UpdateFromOnline(String ProblemId,String title,String problemStatement,String solution,String tag,String setter,int syncstatus,String updateDate){
    ...
    public void UpdateFromOnline(String name,String userName,String password,String gender,String dateBirth,String email,String phone,String institution,String solvingString,String totalSolved,int syncstatus,int logStatus){
