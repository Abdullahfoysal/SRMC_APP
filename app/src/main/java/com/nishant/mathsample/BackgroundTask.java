...
public class BackgroundTask extends AsyncTask<String,Void,String> {
    ...
    protected synchronized String doInBackground(String ... params) {
        ...
        if(method.equals("saveOnline")){//not using this 19/10/19 11:12 PM
            ...
            try {
                ...
                if(response.equals("OK")){
                   ...
                   // DbContract.userInformationUpdateFromServer(ctx);//backgroundTask method="userDataFetching"
           ...
           // String TOTALSOLVED="0";
        ...
        else if(method.equals("saveFromServer")){///problem update to local phone database
                       ...
                       if (cursor.moveToNext()){
                         ...
                         //      return "All problem up to Date";
                          ...
                          // final int updateTime2=cursor.getInt(8);//UpdateTime on local
                               ...
                               if(updateDate.compareTo(updateDate2)>0) //Online data update>offline data update
            ...
            try{
                ...
                for(int i=0;i<ja.length();i++){//here get one person result (loop doesn't need anymore)
    ...
    protected synchronized void onPostExecute(String result) {
        ...
        switch (result){
            case "Login successfully":{
                Intent intent = new Intent (ctx, homeActivity.class);
                intent.putExtra("user", DbContract.CURRENT_USER_NAME);
                intent.putExtra("userType","offline");
                ctx.startActivity(intent);
