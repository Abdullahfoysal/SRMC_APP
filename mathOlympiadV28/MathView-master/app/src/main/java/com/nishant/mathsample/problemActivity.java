...
//    private TextView activityTitle;
    private ImageView methodTypeImage;
    ...
    public void loadData() {
        ...
        methodTypeImage= (ImageView) findViewById(R.id.methodTypeId);
        if(method.equals("allProblem")){
            methodTypeImage.setImageResource(R.drawable.allproblem);
        }else if(method.equals("attempted")){
            methodTypeImage.setImageResource(R.drawable.attempted);
        }else if(method.equals("solved")){
            methodTypeImage.setImageResource(R.drawable.solvedproblem);
        }
