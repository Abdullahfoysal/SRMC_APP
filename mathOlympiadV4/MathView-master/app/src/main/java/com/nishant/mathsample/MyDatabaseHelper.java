...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_USER_INFORMATION_TABLE="CREATE TABLE "+USER_INFORMATION_TABLE+"( "+NAME+" VARCHAR(25), "+USER_NAME+" VARCHAR(25), "+PASSWORD+" VARCHAR(25), "+GENDER+" VARCHAR(25), "+DATE_BIRTH+" VARCHAR(25), "+EMAIL+" VARCHAR(25), "+PHONE_NUMBER+" VARCHAR(25), "+INSTITUTION+" VARCHAR(50), "+SOLVING_STRING+" VARCHAR(10010), "+TOTAL_SOLVED+" VARCHAR(25), "+DbContract.SYNC_STATUS+" INTEGER );";
