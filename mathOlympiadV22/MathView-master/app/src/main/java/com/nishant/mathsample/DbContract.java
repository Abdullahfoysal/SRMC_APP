...
public class DbContract {
    ...
    public static final String SERVER_URL="https://adminsrmcapp.000webhostapp.com/sync.php";//no need on 15/10/19 9:54Pm
    public static final String PROBLEM_DATA_SYNC_URL="https://adminsrmcapp.000webhostapp.com/dataSync.php";//15/10/19->9:16 pm from phone to mysql add problem on phone
    public static final String USERDATASYNC_URL="https://adminsrmcapp.000webhostapp.com/userDataSync.php";//signUp for
    public static final String USER_DATA_UPDATE_URL="https://adminsrmcapp.000webhostapp.com/userDataUpdate.php";//user activity Update
    public static final String SERVER_URL3="http://192.168.0.117/syncdemo/dataFetch.php";//for single information such login
    public static final String SERVER_URL4="https://adminsrmcapp.000webhostapp.com/allDataFetching.php";//15/10/19->8:05 pm
    public static final String ALL_DATA_FETCHING_URL="https://adminsrmcapp.000webhostapp.com/allDataFetching.php";//15/10/19->8:05 pm
    public static final String USER_DATA_FETCHING_URL="https://adminsrmcapp.000webhostapp.com/userDataFetching.php";
    public static final String ALL_USER_STATICS_DATA_URL="https://adminsrmcapp.000webhostapp.com/userRankingDataFetching.php";//ranking of statics
    public static final String USER_RANK_SOLVING_STRING_DATA_URL="https://adminsrmcapp.000webhostapp.com/userRankSolvingStringFetching.php";//ranked user solvingString data
    public static final String LOGIN_DATA_FETCHING_URL="https://adminsrmcapp.000webhostapp.com/userLogin.php";//15/10/19->8:05 pm
    public static final String CHECK_SIGNUP_DATA_FETCHING_URL="https://adminsrmcapp.000webhostapp.com/checkSignUp.php";
                                ...
                                public void onResponse(String response) {
                                    try {
                                        ...
                                        if (Response.equals("OK")) {
                                            ...
                                            Toast.makeText(ctx,"saveToAppServer",Toast.LENGTH_SHORT).show();
